...
public class UserTakeLimitRuleFilter implements ILogicHandler<TradeLockRuleCommandEntity, TradeLockRuleFilterFactory.DynamicContext, TradeLockRuleFilterBackEntity> {
    ...
    public TradeLockRuleFilterBackEntity apply(TradeLockRuleCommandEntity requestParameter, TradeLockRuleFilterFactory.DynamicContext dynamicContext) throws Exception {
        ...
        log.info("交易规则过滤-用户参与次数校验{} activityId:{} count:{} takeLimitCount:{}", requestParameter.getUserId(), count, requestParameter.getActivityId(), groupBuyActivity.getTakeLimitCount());
        //校验用户是否超过了活动的参与次数限制
